...
class Donor(models.Model):
	...
	image=models.ImageField(help_text='Attach your photo', upload_to='upload/donor_images', default="default.png")
...
class Message(models.Model):
	...
	message=models.TextField(default='', help_text='Write your message here')
	MESSAGE_STATUS=(
		('r', 'Read'),
		('un', 'Unread'),
		)
